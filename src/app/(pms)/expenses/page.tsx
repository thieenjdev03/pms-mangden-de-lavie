...
import type { Expense, Villa } from "@/lib/data";
...
export default function ExpensesPage() {
  ...
  const load = useCallback(() => {
    void Promise.all([fetch("/api/expenses"), fetch("/api/villas")]).then(async ([re, rv]) => {
      const expenses = (await re.json()) as Expense[];
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Select
                options={villas.map((v) => ({ value: v.name, label: v.name }))}
